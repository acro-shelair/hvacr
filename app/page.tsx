...
export default function HomePage() {
  return (
    <>
      ...
      {/* HERO */}
      <section className="relative flex flex-col min-h-[calc(100svh-72px)] lg:min-h-screen overflow-hidden -mt-[72px] pt-[72px]">
        ...
        <div className="container-main relative z-10 flex-1 flex items-center py-12 sm:py-16 lg:py-20 lg:pb-44">
          <div className="w-full">
            <p className="hero-eyebrow mb-4 sm:mb-6">Trusted Trade Services Since 1972</p>
            <h1 className="font-display font-extrabold text-primary-foreground text-[32px] sm:text-[40px] md:text-[56px] lg:text-[72px] leading-[1.1] max-w-[800px] mb-4 sm:mb-6">
              <HeroWordReveal text="Queensland's Most Trusted Refrigeration & Climate Control Group" />
            </h1>
            <p className="text-primary-foreground/80 font-body text-base sm:text-lg md:text-xl max-w-[600px] mb-8 sm:mb-10 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
              <Link href="/brands" className="btn-primary w-full sm:w-auto">Explore Our Brands</Link>
              <Link href="/about" className="btn-outline-white w-full sm:w-auto">About Us</Link>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 lg:absolute lg:bottom-0 lg:left-0 lg:right-0">
          <div className="container-main">
            <div className="bg-card rounded-t-xl grid grid-cols-2 lg:grid-cols-4 shadow-[var(--shadow-card)]">
              {stats.map((stat, i) => (
                <div
                  key={i}
                ...
                >
                  <span className="stat-number text-xl sm:text-2xl md:text-4xl block mb-1">{stat.value}</span>
      ...
      <section className="section-padding bg-surface-alt">
        <div className="container-main">
          <AnimatedSection className="text-center mb-10 sm:mb-12 md:mb-16">
            ...
            <p className="text-muted-foreground font-body text-base sm:text-lg max-w-[650px] mx-auto">
      ...
      <section className="relative bg-navy diagonal-texture overflow-hidden">
        ...
        <div className="container-main section-padding text-center relative z-10">
          <AnimatedSection>
            ...
            <p className="text-primary-foreground/70 font-body text-base sm:text-lg mb-6 sm:mb-8 max-w-[500px] mx-auto">
              Our team is ready to help with refrigeration, air conditioning, or cold room solutions.
            </p>
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
              <a href="tel:1300227600" className="btn-primary gap-2 w-full sm:w-auto">
                <Phone className="w-4 h-4" /> Call 1300 227 600
              </a>
              <Link href="/contact" className="btn-outline-white w-full sm:w-auto">Send an Enquiry</Link>
            </div>
          </AnimatedSection>
        </div>
      </section>
